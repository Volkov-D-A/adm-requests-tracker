...
const (
	...
	TSRService_GetArchivTickets_FullMethodName       = "/tsr.v1.TSRService/GetArchivTickets"
...
type TSRServiceClient interface {
	...
	GetArchivTickets(ctx context.Context, in *GetArchivTicketsRequest, opts ...grpc.CallOption) (*GetArchivTicketsResponse, error)
...
func (c *tSRServiceClient) GetArchivTickets(ctx context.Context, in *GetArchivTicketsRequest, opts ...grpc.CallOption) (*GetArchivTicketsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetArchivTicketsResponse)
	err := c.cc.Invoke(ctx, TSRService_GetArchivTickets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TSRServiceServer interface {
	...
	GetArchivTickets(context.Context, *GetArchivTicketsRequest) (*GetArchivTicketsResponse, error)
...
func (UnimplementedTSRServiceServer) GetArchivTickets(context.Context, *GetArchivTicketsRequest) (*GetArchivTicketsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetArchivTickets not implemented")
}
...
func _TSRService_GetArchivTickets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetArchivTicketsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TSRServiceServer).GetArchivTickets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TSRService_GetArchivTickets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TSRServiceServer).GetArchivTickets(ctx, req.(*GetArchivTicketsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TSRService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetArchivTickets",
			Handler:    _TSRService_GetArchivTickets_Handler,
		},
		{
